...
def rho_dot(Hamiltonian, Gamma, rho):
    ...
    """
    return -1j / hbar * commutator(Hamiltonian, rho) - 1 / 2 * anticommutator(Gamma, rho) + sp.asarray([[Gamma[2, 2] * rho[2, 2], 0, 0], [0, 0, 0], [0, 0, 0]])
...
def time_evolve(Hamiltonian, Gamma, rho, dt, nt):
    """
